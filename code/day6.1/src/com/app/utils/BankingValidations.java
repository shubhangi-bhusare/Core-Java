...
//add public static method to validate for min bal
	...
	public static BankAccount validateInputs(int acctNo, String fName, String lastName, String acType, String dob,
			String creationDate, double balance, List<BankAccount> accounts) throws BankingException {
	...
	public static void checkForDup(int acctNo, List<BankAccount> accts) throws BankingException {
