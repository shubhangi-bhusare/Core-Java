...
API
1. java.util.Date--- class represents system date n time , till the msec precision
Constructor
1.Date() --- creates Date class instance representing  current date n time (till ms precision)
2.Date(long msec) --- creates Date class instance representing date n time  for msec elapsed after epoch(=1st Jan 1970)
eg : Date d1=new Date(100);
Important Methods --toString,before,after,equals,compareTo
---------------------
